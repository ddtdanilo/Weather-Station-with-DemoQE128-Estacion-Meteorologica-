...
void Senal_25u_2_Init(void)
{
  ...
  /* TPM1MOD: BIT15=0,BIT14=0,BIT13=0,BIT12=0,BIT11=0,BIT10=0,BIT9=1,BIT8=0,BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=0,BIT2=1,BIT1=0,BIT0=0 */
  setReg16(TPM1MOD, 0x0274U);          /* Set modulo register */ 
