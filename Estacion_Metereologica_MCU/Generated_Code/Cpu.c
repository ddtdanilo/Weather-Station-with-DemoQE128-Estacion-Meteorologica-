...
/*
** ===================================================================
**     Method      :  Cpu__ivVkeyboard (component MC9S08QE128_80)
**
**     Description :
**         This method is internal. It is used by Processor Expert only.
** ===================================================================
*/
ISR(Cpu__ivVkeyboard)
{
  if (KBI2SC_KBF) {                    /* Is the interrupt flag set? */
    KBI2SC_KBACK = 1U;                 /* If yes then clear an interrupt flag */
    Int_Anemometro_1();
  }
  if (KBI1SC_KBF) {                    /* Is the interrupt flag set? */
    KBI1SC_KBACK = 1U;                 /* If yes then clear an interrupt flag */
    Int_Anemometro_2();
  }
}
...
void PE_low_level_init(void)
{
  ...
  /* PTBDD: PTBDD5=1,PTBDD2=0,PTBDD1=1,PTBDD0=0 */
  clrSetReg8Bits(PTBDD, 0x05U, 0x22U);  
  /* PTBD: PTBD5=0,PTBD1=1 */
  clrSetReg8Bits(PTBD, 0x20U, 0x02U);   
  /* PTADD: PTADD1=1 */
  setReg8Bits(PTADD, 0x02U);            
  /* PTAD: PTAD1=0 */
  clrReg8Bits(PTAD, 0x02U);             
  /* PTDDD: PTDDD1=0 */
  clrReg8Bits(PTDDD, 0x02U);            
  /* PTDPE: PTDPE1=0 */
  clrReg8Bits(PTDPE, 0x02U);            
  /* PTCD: PTCD7=1,PTCD1=0,PTCD0=0 */
  clrSetReg8Bits(PTCD, 0x03U, 0x80U);   
  ...
  /* ### Asynchro serial "S1" init code ... */
  S1_Init();
  /* ### Programable pulse generation "Senal_25u" init code ... */
  Senal_25u_Init();
  /* ### FreeCntr "Tiempo" init code ... */
  Tiempo_Init();
  /* ### External interrupt "Entrada_Anemometro_1" init code ... */
  /* KBI2PE: KBIPE1=1 */
  KBI2PE |= 0x02U;
  ...
  KBI2SC_KBIE = 0x01U;
  /* ### Asynchro serial "S2" init code ... */
  S2_Init();
  /* ### BitIO "S1_LED" init code ... */
  /* ### BitIO "S2_LED" init code ... */
  /* ###  "AD1" init code ... */
  AD1_Init();
  /* ### Programable pulse generation "Senal_25u_2" init code ... */
  Senal_25u_2_Init();
  /* ### External interrupt "Entrada_Anemometro_2" init code ... */
  /* KBI1PE: KBIPE6=1 */
  KBI1PE |= 0x40U;
